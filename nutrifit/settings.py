...
SECRET_KEY = os.getenv('SECRET_KEY', "django-insecure-@%t_un4fib84m^3)g41t9c5sgz%a=+-q@$7qon@1cs78y0-=f=")
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'nutri.fit.web.customer@gmail.com'
EMAIL_HOST_PASSWORD = 'pjmu eanl gmvp vcyt'  # app password if 2FA is enabled
